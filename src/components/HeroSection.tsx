...
<section className="relative min-h-[80vh] md:min-h-[90vh] overflow-hidden flex items-center">
  ...
  {/* IMAGE (Optimized for both Mobile & Desktop) */}
 <div className="absolute inset-0 flex items-center justify-center bg-black">
    <img
      src="/heroimage.png"
      alt="LAHLINO Hero"
      /* object-center katjib tsawira f l'wst exacte */
  ...
  <div className="relative z-10 container mx-auto px-0 md:px-6 max-w-7xl w-full">
    <div className="grid md:grid-cols-12 items-center">
      ...
      <div className="md:col-span-6 lg:col-span-5 flex w-full justify-center md:justify-start">
        ...
        {/* Hna fin drna l'fix: w-[92%] md:w-full mx-auto */}
        <div className="
          w-[88%] sm:w-[85%] md:w-full max-w-md mx-auto md:mx-0
          rounded-[32px]
          border border-white/10
          
          backdrop-blur-sm
          p-2 md:p-1
          shadow-[0_0_60px_rgba(255,192,203,0.12)]
